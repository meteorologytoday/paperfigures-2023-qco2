...
fig, ax = plt.subplots(2 * len(plot_cases)//2, 2, sharey=False, sharex=True, figsize=(6 * 2, 3 * (2*len(plot_cases) / 2)), constrained_layout=True, squeeze=False)
...
for exp_name, caseinfo in sim_casenames.items():
    ...
    ax_ocn.set_xticklabels(["20S", "10S", "EQ", "10N", "20N"])
